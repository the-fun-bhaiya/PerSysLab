(() => {
  ...
  document.querySelector("#form").addEventListener("keypress", async (event) => {
    event.key == "Enter"
      ? submitBtn.click()
    ...
    submitBtn.addEventListener("click", async (event) => {
      ...
      if (typeof resData.redirectedUrl !== "undefined") window.location.assign(resData.redirectedUrl)
